...
document.addEventListener("DOMContentLoaded", () => {
  ...
  addFilterBlocks();
  addFilterChips();
  const techNewsFilterContainer = document.querySelector('.FilterContainer');
  const techNewsFilter = document.querySelector('.Filter');
  const openFilter = document.querySelector('.headerPagesFilterButton');
  const redDot = openFilter.querySelector('.redCircle');
  const closeFilter = techNewsFilter.querySelector('.FilterClose');
  ...
  openFilter.addEventListener('click', () => {
    techNewsFilterContainer.classList.remove('mainHidden');
  });

  closeFilter.addEventListener('click', () => {
    techNewsFilterContainer.classList.add('mainHidden');
  });
